...
public class CalculatorTest {
    ...
    void computeLengthCircle() {
        Calculator calculator = new Calculator();
        calculator.computeLengthCircle(10);
...
//HW3
    @Test
    void testEvenOddNumberIsTrue() {
        Calculator calculator = new Calculator();
        calculator.evenOddNumber(2);
        assertTrue(calculator.evenOddNumber(2));
    }

    @Test
    void testEvenOddNumberIsTrueNumberIsNull() {
        Calculator calculator = new Calculator();
        calculator.evenOddNumber(0);
        assertTrue(calculator.evenOddNumber(0));
    }

    @Test
    void testEvenOddNumberIsTrueNumberNegative() {
        Calculator calculator = new Calculator();
        calculator.evenOddNumber(-2);
        assertTrue(calculator.evenOddNumber(-2));
    }
    ...
    @Test
    void testEvenOddNumberIsFalse() {
        Calculator calculator = new Calculator();
        calculator.evenOddNumber(3);
        assertFalse(calculator.evenOddNumber(3));
    }

    @Test
    void testEvenOddNumberIsFalseNumberNegative() {
        Calculator calculator = new Calculator();
        calculator.evenOddNumber(-3);
        assertFalse(calculator.evenOddNumber(-3));
    }
    ...
    @Test
    void testNumberIsInInterval() {
        Calculator calculator = new Calculator();
        Calculator.numberInInterval(50);
        assertTrue(calculator.numberInInterval(50));
    }

    @Test
    void testNumberIsOverInterval() {
        Calculator calculator = new Calculator();
        calculator.numberInInterval(101);
        assertFalse(calculator.numberInInterval(101));
    }

    @Test
    void testNumberLessThanInterval() {
        Calculator calculator = new Calculator();
        calculator.numberInInterval(24);
        assertFalse(calculator.numberInInterval(24));
    }

    @Test
    void testNumberLessThanIntervalIsNull() {
        Calculator calculator = new Calculator();
        calculator.numberInInterval(0);
        assertFalse(calculator.numberInInterval(0));
    }

    @Test
    void testNumberLessThanIntervalIsNegative() {
        Calculator calculator = new Calculator();
        calculator.numberInInterval(-24);
        assertFalse(calculator.numberInInterval(-24));
    }
